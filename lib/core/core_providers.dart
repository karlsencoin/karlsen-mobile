...
final _karlsenApiProvider = Provider<KarlsenApi>((ref) {
  ...
  return switch (networkId) {
    kKarlsenNetworkIdMainnet =>
      KarlsenApiMainnet('https://api.karlsencoin.org'),
    kKarlsenNetworkIdTestnet10 =>
      KarlsenApiMainnet('https://api.testnet-1.karlsencoin.org'),
    kKarlsenNetworkIdTestnet11 =>
      KarlsenApiMainnet('https://api.testnet-11.karlsencoin.org'),
    _ => KarlsenApiEmpty(),
  };
});
