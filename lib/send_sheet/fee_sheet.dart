...
class FeeSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    //final symbol = ref.watch(klsSymbolProvider);
    ...
    void onValueChanged(String text) {
      final value = karlsenFormatter.tryParse(text);
        ...
        children: [
          ...
          FiatValueContainer(
            ...
            child: AppTextField(
              ...
              inputFormatters: [karlsenFormatter],
              onChanged: onValueChanged,
              textInputAction: TextInputAction.done,
              maxLines: null,
              autocorrect: false,
              hintText: hint.value ?? l10n.feePriorityHint,
              prefixButton: TextFieldButton(widget: KlsIconWidget()),
