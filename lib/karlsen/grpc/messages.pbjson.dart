...
@$core.Deprecated('Use karlsendRequestDescriptor instead')
const KarlsendRequest$json = {
  '1': 'KarlsendRequest',
  '2': [
...
/// Descriptor for `KarlsendRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List karlsendRequestDescriptor = $convert.base64Decode(
...
@$core.Deprecated('Use karlsendResponseDescriptor instead')
const KarlsendResponse$json = {
  '1': 'KarlsendResponse',
  '2': [
    {'1': 'id', '3': 101, '4': 1, '5': 4, '10': 'id'},
...
/// Descriptor for `KarlsendResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List karlsendResponseDescriptor = $convert.base64Decode(
