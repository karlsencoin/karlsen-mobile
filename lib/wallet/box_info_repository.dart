...
BoxInfo _genBoxInfo({
  ...
  final addressBoxKey = hash('addressBoxKey#KarlsenNetwork.$networkId#$wid');
  final balanceBoxKey = hash('balanceBoxKey#KarlsenNetwork.$networkId#$wid');
  final utxoBoxKey = hash('utxoBoxKey#KarlsenNetwork.$networkId#$wid');
  final txIndexBoxKey = hash('txIndexBoxKey#KarlsenNetwork.$networkId#$wid');
  final txBoxKey = hash('txBoxKey#KarlsenNetwork.$networkId#$wid');
    ...
    if (!bundle.wasMigrated) {
      ...
      bundle = bundle.copyWith(
        byNetworkId: mainnet != null
            ? {
                ...bundle.byNetworkId,
                kKarlsenNetworkIdMainnet: mainnet,
              }
            : bundle.byNetworkId,
        wasMigrated: true,
      );
